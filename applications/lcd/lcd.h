 ...
 */
#ifndef APPLICATIONS_LCD_LCD_H_
#define APPLICATIONS_LCD_LCD_H_
#include <rtthread.h>
#include "stm32f4xx.h"
...
//LCD的画笔颜色和背景色
extern rt_uint32_t  POINT_COLOR;//默认红色
extern rt_uint32_t  BACK_COLOR; //背景颜色.默认为白色
...
void LCD_Clear(rt_uint32_t Color);                                                  //清屏
void LCD_SetCursor(rt_uint16_t Xpos, rt_uint16_t Ypos);                                     //设置光标
void LCD_DrawPoint(rt_uint16_t x,rt_uint16_t y);                                            //画点
void LCD_Fast_DrawPoint(rt_uint16_t x,rt_uint16_t y,rt_uint32_t color);                             //快速画点
rt_uint32_t  LCD_ReadPoint(rt_uint16_t x,rt_uint16_t y);                                            //读点
...
void LCD_Fill(rt_uint16_t sx,rt_uint16_t sy,rt_uint16_t ex,rt_uint16_t ey,rt_uint32_t color);                       //填充单色
